function [sig,tau] = steps_ictgv2_dmri_noncart(x,sig,tau,ts,t1,ts2,t2,s_t_ratio,mri_obj)
	...
	Kx2 = abs( backward_opt_noncart( x(:,:,:,1),mri_obj.nufft_st,mri_obj.b1,mri_obj.dcf ) );
