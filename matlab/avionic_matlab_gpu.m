...
switch method
    ...
    case 'TV'
        ...
        methodstr = [...
            ...
            ' --tv.alpha0=',num2str(alpha0),...
            ' --tv.alpha1=',num2str(alpha1),' '];
    case 'TGV2_3D'
        voxelscalestr = [...
...
%------------------------------------------------------------------
recon_cmd=['/home/mr_recon/Workspace/AVIONIC/CUDA/bin/avionic ',scalestr,alstr,debugstr, ' -i ',num2str(stop_par),...
    methodstr,...
    voxelscalestr,...
